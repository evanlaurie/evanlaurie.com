...
$projects = array(
  ...
  'personal' => array(
    'wedding' => array(
      'title' 			=> 'Elise & Evan | Maui\'d',
      'description' => 'Our Maui wedding website.',
      'img'         => 'mauid.png',
      'url'					=> 'http://wedding.thelauries.com/'
    )
  ),
);  
  
?>
<h3 class="category-header">Institute for Health Metrics and Evaluation</h3>
<div calss="category-content">
<?php foreach($projects['ihme'] as $id => $project): ?>
...
<h3 class="category-header">Personal</h3>
<div calss="category-content">
<?php foreach($projects['personal'] as $id => $project): ?>
<div class="project-container" id="project-container-<?php print $id; ?>">
	<div class="project-sizer"></div>
	<a href="<?php print $project['url']; ?>" target="_BLANK">
		<div class="project" id="project-<?php print $id; ?>" style="background-image: url('img/projects/<?php print $project['img']; ?>');">
